...
const createProjects = () => {
  ...
  program
    ...
    .description('create a VUE TS component template')
    .action((filename, path) => {
  ...
  // 创建模块目录
  program
    .command('module <project> [others...]')
    .description('create a dir template')
    .action((filename, path) => {
      createVueTSDirTemplateAction(filename, path[0] || '')
    })
}
